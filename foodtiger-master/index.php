...
<body>
    <header>        
        ...
        <nav class="navbar navbar-expand-md bg-warning navbar-dark fixed-top">
            ...
            <form class="modal-content animate" action="../index/logincode.php" method="POST">
            ...
            <div id="id02" class="modal">
                <form class="modal-content animate" name="register" action="../index/registercode.php" method="POST"  style="margin-top:0%;">
                    <div class="imgcontainer">
