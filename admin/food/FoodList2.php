        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" action="updateFood.php" method="POST"
                    ...
                    <input name="f_id" type="text" class="form-control" placeholder=""
                        value="<?php if (isset($_GET['f_id'])){echo  $_SESSION['f_id']; }?>" style="display: none;">
                    <input name="cart_id" type="text" class="form-control" placeholder=""
                        value="<?php if (isset($_GET['f_id'])){echo $_SESSION['cart_id']; }?>" style="display: none;">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="nameFood" id="nameFood"
                                value="<?php if (isset($_GET['f_id'])){echo  $_SESSION['nameFood']; }?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="description" id="description"
                                value="<?php if (isset($_GET['f_id'])){echo $_SESSION['description']; }?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="price" id="price"
                                value="<?php if (isset($_GET['f_id'])){echo $_SESSION['price']; }?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <img src="<?php if (isset($_GET['f_id'])){echo $_SESSION['image']; }?>"
