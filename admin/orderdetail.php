          ...
          <div class="panel-body">
            <table class="table ">
              ...
              <tbody>
                ...
                <tr>
                  <td class='text-left' colspan='3'>Food</td>
            ...
            ?>
                <tr>
                  <td class='text-left' colspan='3'><?php echo $row['foodname'];?> </td>
            ...
            <div style="text-align: center;"><a href="paymenthistory.php"><button type="button"
                  class="btn btn-warning">Leave</button></a></div>
          </div>
        </div>
      </div>
    </div>
