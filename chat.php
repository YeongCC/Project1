...
<div class="chat-popup" id="myForm">
  ...
  <div id="chat_history_"></div>
    ...
    <textarea placeholder="Type message.." name="message" id="message" class="message" required></textarea>

    <button type="submit" class="btn chat_but btn-warning" id="chat_but" name="chat_but">Send</button>
